...
UKPOI_BASE = {
    ...
    # Eval:
    'compute_test_loss': True,
    'queries_csv': './ukpoi.csv',
    'num_eval_queries_per_iteration': 0,
    'num_eval_queries_at_end': 100,
    'eval_psamples': [4000],
...
LIVEJOURNAL_BASE = {
    'dataset': 'livejournal',
    'join_tables': ['livejournal'],
    'join_keys': {'livejournal': []},
    # Sampling starts at this table and traverses downwards in the join tree.
    'join_root': 'livejournal',
    'disable_learnable_unk': False,
    'per_row_dropout': True,
    'dropout': 1,
    'table_dropout': False,
...
EXPERIMENT_CONFIGS = {
    ...
    'livejournal': dict(
        dict(BASE_CONFIG, **LIVEJOURNAL_BASE),
        **{
            'factorize': True,
            'grouped_dropout': True,
            'loader_workers': 4,
    ...
    'geotweet': dict(
        dict(BASE_CONFIG, **GEOTWEET_BASE),
        **{
            'factorize': True,
            'grouped_dropout': True,
            'loader_workers': 4,
    ...
    'geotweet-large': dict(
        dict(dict(BASE_CONFIG, **GEOTWEET_BASE), **FACTORIZE),
        **{
            'num_eval_queries_per_iteration': 100,
            'loader_workers': 4,
            'eval_psamples': [8000],
...
TEST_CONFIGS['test-ukpoi'] = dict(
    EXPERIMENT_CONFIGS['ukpoi'],
    **{
        'queries_csv': '../query/ukpoi/ukpoi_query_2.csv',
        'epochs': 10,
        'asserts': {
...
TEST_CONFIGS['test-gn'] = dict(
    EXPERIMENT_CONFIGS['gn'],
    **{
        'word_size_bits':14, 
        'epochs': 10,
        'asserts': {
...
TEST_CONFIGS['test-bookc'] = dict(
    EXPERIMENT_CONFIGS['bookc'],
    **{
        'word_size_bits':14, 
        'epochs': 10,
        'eval_psamples': [1000],
...
TEST_CONFIGS['test-livejournal'] = dict(
    EXPERIMENT_CONFIGS['livejournal'],
    **{
        'word_size_bits':14, 
        'epochs': 10,
        'eval_psamples': [1000],
...
TEST_CONFIGS['test-geotweet'] = dict(
    EXPERIMENT_CONFIGS['geotweet'],
    **{
        'word_size_bits': 16,
        #'factorize_blacklist': ['tags0', 'tags1', 'tags2', 'tags3', 'tags4', 'tags5', 'tags6', 'tags7', 'tags8', 'tags9', 'tags10', 'tags11', 'tags12', 'tags13', 'tags14', 'tags15', 'tags16', 'tags17', 'tags18', 'tags19'],
        #'percentage_csv': None,
        'epochs': 10,
        'asserts': {
            'fact_psample_8000_median': 4,
...
TEST_CONFIGS['test-geotweet-large'] = dict(
    EXPERIMENT_CONFIGS['geotweet-large'],
    **{
        'epochs': 10,
        'asserts': {
            'fact_psample_8000_median': 4,
...
TEST_CONFIGS['job-light-ranges-reload'] = dict(
    EXPERIMENT_CONFIGS['job-light-ranges'],
    **{
        'checkpoint_to_load': 'models/imdb-10.4MB-model43.014-made-resmade-hidden256_256_256_256-emb16-directIo-embedInembedOut-embsTied-dropout-learnableUnk-factorized-groupedDropout-14wsb-10epochs-10.24Mtups-seed0.pt',
        'eval_psamples': [8000],
...
TEST_CONFIGS['ukpoi-reload'] = dict(
    EXPERIMENT_CONFIGS['ukpoi'], **{
        'checkpoint_to_load': tune.grid_search([
            'models/ukpoi-1.8MB-model30.125-made-resmade-hidden128_128_128_128-emb32-directIo-embedInembedOut-embsTied-factorized-11wsb-10epochs-seed0.pt',
        ]),
        'eval_psamples': [8000],
        'asserts': {
            'fact_psample_512_median': 1.7,
...
TEST_CONFIGS['bookc-reload'] = dict(
    EXPERIMENT_CONFIGS['bookc'], **{
        'word_size_bits': 14,
        'eval_psamples': [1000],
        'asserts': {
...
TEST_CONFIGS['livejournal-reload'] = dict(
    EXPERIMENT_CONFIGS['livejournal'], **{
        'checkpoint_to_load': tune.grid_search([
            'models/geotweet_settrie_{}_{}.pt',
...
TEST_CONFIGS['geotweet-reload'] = dict(
    EXPERIMENT_CONFIGS['geotweet'], **{
        'checkpoint_to_load': tune.grid_search([
            #'models/gn-7.4MB-model67.689-made-resmade-hidden128_128_128_128-emb32-directIo-embedInembedOut-embsTied-factorized-11wsb-10epochs-seed0.pt',
            'models/geotweet-59.0MB-model100.757-transformer-blocks6-model64-ff256-heads4-gelu-dropout-10epochs-seed0.pt',
