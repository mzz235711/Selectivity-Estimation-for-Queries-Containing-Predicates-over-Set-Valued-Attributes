...
int main(int argc, char** argv) {
  ...
  */
  ...
  std::string partfilename = output_folder +  "/part.txt";
  ...
  std::cout << "cp3\n"; 
  std::string output_filename = output_folder + "/dis_set_map.txt";
  ...
  // Store the tree
  std::string output_treename = output_folder + "/settrie.txt";
