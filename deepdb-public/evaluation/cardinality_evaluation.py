...
def evaluate_cardinalities(ensemble_location, physical_db_name, query_filename, target_csv_path, percentage_file_path, schema,
    ...
    percentages = None
    if percentage_file_path is not None:
        percentage_file = open(percentage_file_path)
        percentages = percentage_file.readlines()
    ...
    for query_no, query_str in enumerate(queries):
        ...
        if percentages is not None:
            percentage_str = percentages[query_no]
        glo.set_value("percentage_str", percentage_str)
