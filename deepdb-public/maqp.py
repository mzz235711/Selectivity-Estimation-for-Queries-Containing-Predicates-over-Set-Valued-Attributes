...
from schemas.geotweet.schema import gen_geotweet_schema
from schemas.gn.schema import gen_gn_schema
from schemas.livejournal.schema import gen_livejournal_schema
from schemas.wiki.schema import gen_wiki_schema
...
if __name__ == '__main__':
    ...
    parser.add_argument('--percentage_file_location', default=None, type=str)
    ...
    elif args.dataset == 'geotweet':
        schema = gen_geotweet_schema(table_csv_path, partnum=args.partnum, keepnum=args.keepnum)
    elif args.dataset == 'gn':
        schema = gen_gn_schema(table_csv_path, partnum=args.partnum, keepnum=args.keepnum)
    elif args.dataset == 'livejournal':
        schema = gen_livejournal_schema(table_csv_path, partnum=args.partnum, keepnum=args.keepnum) 
    elif args.dataset == 'wiki':
        schema = gen_wiki_schema(table_csv_path, partnum=args.partnum, keepnum=args.keepnum) 
    else:
    ...
    if args.evaluate_cardinalities_scale:
        ...
        for i in [3, 4, 5, 6]:
            for j in [1, 2, 3, 4, 5]:
                ...
                percentage_file_location = args.percentage_file_location.format(i, j)
                evaluate_cardinalities(args.ensemble_location, args.database_name, query_file_location, target_path, percentage_file_location,
    ...
    if args.evaluate_cardinalities:
        ...
        evaluate_cardinalities(args.ensemble_location, args.database_name, args.query_file_location, args.target_path,
                               args.percentage_file_location, schema, args.rdc_spn_selection, args.pairwise_rdc_path,
                               use_generated_code=args.use_generated_code,
                               merge_indicator_exp=args.merge_indicator_exp,
                               exploit_overlapping=args.exploit_overlapping, max_variants=args.max_variants,
